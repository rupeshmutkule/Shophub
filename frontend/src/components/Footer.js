        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/category/tumblers" className="hover:text-white transition-colors">
                  Tumblers
                </Link>
              </li>
              <li>
                <Link to="/category/glassware" className="hover:text-white transition-colors">
                  Glassware
                </Link>
              </li>
              <li>
                <Link to="/category/crockery" className="hover:text-white transition-colors">
                  Crockery
                </Link>
              </li>
              <li>
                <Link to="/category/cups" className="hover:text-white transition-colors">
                  Cups
                </Link>
              </li>
            </ul>
